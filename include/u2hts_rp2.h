...
#define U2HTS_PHYSICAL_MAX_X 4095
#define U2HTS_PHYSICAL_MAX_Y 4095
// clang-format off
...
#define U2HTS_HID_TP_INFO \
      ...
      HID_USAGE(0x56), \
        HID_INPUT(HID_DATA | HID_VARIABLE | HID_ABSOLUTE), \
      HID_USAGE(0x54), \
      HID_LOGICAL_MAX(U2HTS_MAX_TPS), \
      HID_REPORT_SIZE(8), \
        HID_INPUT(HID_DATA | HID_VARIABLE | HID_ABSOLUTE)

#define U2HTS_HID_TP_MAX_COUNT_DESC(id) \
      HID_REPORT_ID(id) \
      HID_USAGE(0x55), \
        HID_FEATURE(HID_DATA | HID_VARIABLE | HID_ABSOLUTE)

#define U2HTS_HID_TP_MS_THQA_CERT_DESC(id) \
      HID_REPORT_ID(id) \
